...
void Renderable::createShader(QObject *glFunctions)
{
...
void Renderable::render(QOpenGLFunctions_4_1_Core *glFunctions, QMatrix4x4 &projectionMatrix)
{
...
void Renderable::createBuffers(QOpenGLFunctions_4_1_Core *glFunctions)
{
...
void Renderable::updateBuffers(QOpenGLFunctions_4_1_Core *glFunctions)
{
  glFunctions->glBindVertexArray(m_vao);
...
void Renderable::load_obj(const char *filename)
{
